...
export const STYLE_STORY_TONES: Record<BookStyle, string> = {
  'fairy-tale':
    'волшебная сказка в духе доброй народной: живые реплики зверей и героев, ясные чудеса, лёгкий юмор и удивление, без сухого пересказа',
  comic:
    'озорная история как хороший мульткомикс: шутки и каламбуры по возрасту, быстрый темп, перебивки в диалогах, смешные мелочи',
  pixar:
    'история в духе Pixar: тёплый юмор, искренние короткие диалоги, эмоциональные повороты и светлый финал без менторства лицом к лицу',
};
